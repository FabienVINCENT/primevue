...
// module
exports.push([module.i, ".p-slider{position:relative}.p-slider .p-slider-handle{cursor:-webkit-grab;cursor:grab;-ms-touch-action:none;touch-action:none}.p-slider-range,.p-slider .p-slider-handle{position:absolute;display:block}.p-slider-horizontal .p-slider-range{top:0;left:0;height:100%}.p-slider-horizontal .p-slider-handle{top:50%}.p-slider-vertical{height:100px}.p-slider-vertical .p-slider-handle{left:50%}.p-slider-vertical .p-slider-range{bottom:0;left:0;width:100%}", ""]);
...
"use strict";
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_6_oneOf_1_0_node_modules_css_loader_index_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Slider_vue_vue_type_style_index_0_id_7f2b7757_prod_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("2676");
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_6_oneOf_1_0_node_modules_css_loader_index_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Slider_vue_vue_type_style_index_0_id_7f2b7757_prod_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_6_oneOf_1_0_node_modules_css_loader_index_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Slider_vue_vue_type_style_index_0_id_7f2b7757_prod_lang_css___WEBPACK_IMPORTED_MODULE_0__);
...
// load the styles
var content = __webpack_require__("1bd0");
if(content.__esModule) content = content.default;
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var add = __webpack_require__("499e").default
var update = add("5d395d29", content, true, {"sourceMap":false,"shadowMode":false});
...
// CONCATENATED MODULE: ./src/components/slider/Slider.vue?vue&type=template&id=7f2b7757&
...
/* harmony default export */ var Slidervue_type_script_lang_js_ = ({
  ...
  methods: {
    updateDomData: function updateDomData() {
      ...
      this.initX = rect.left + DomHandler_DomHandler.getWindowScrollLeft();
      this.initY = rect.top + DomHandler_DomHandler.getWindowScrollTop();
    ...
    onDragStart: function onDragStart(event, index) {
      ...
      DomHandler_DomHandler.addClass(this.$el, 'p-slider-sliding');
      this.dragging = true;
      this.updateDomData();
    ...
    onDragEnd: function onDragEnd(event) {
      if (this.dragging) {
        this.dragging = false;
        DomHandler_DomHandler.removeClass(this.$el, 'p-slider-sliding');
        this.$emit('slideend', {
          originalEvent: event,
          value: this.value
        });
    ...
    onBarClick: function onBarClick(event) {
      ...
      if (!DomHandler_DomHandler.hasClass(event.target, 'p-slider-handle')) {
        this.updateDomData();
        this.setValue(event);
      }
    },
...
// EXTERNAL MODULE: ./src/components/slider/Slider.vue?vue&type=style&index=0&id=7f2b7757&prod&lang=css&
var Slidervue_type_style_index_0_id_7f2b7757_prod_lang_css_ = __webpack_require__("1f6b");
...
/* harmony default export */ var entry_lib = __webpack_exports__["default"] = (Slider);
