...
function getHostOffset(el) {
  ...
  var targetTop = offset.top + DomHandler_DomHandler.getWindowScrollTop();
  return {
    left: targetLeft,
    top: targetTop
  };
...
function alignRight(el) {
  ...
  var left = hostOffset.left + DomHandler_DomHandler.getOuterWidth(el);
  var top = hostOffset.top + (DomHandler_DomHandler.getOuterHeight(el) - DomHandler_DomHandler.getOuterHeight(tooltipElement)) / 2;
...
function alignLeft(el) {
  ...
  var tooltipElement = getTooltipElement(el);
  var hostOffset = getHostOffset(el);
  var left = hostOffset.left - DomHandler_DomHandler.getOuterWidth(tooltipElement);
  var top = hostOffset.top + (DomHandler_DomHandler.getOuterHeight(el) - DomHandler_DomHandler.getOuterHeight(tooltipElement)) / 2;
  tooltipElement.style.left = left + 'px';
  tooltipElement.style.top = top + 'px';
}
function alignTop(el) {
  ...
  var tooltipElement = getTooltipElement(el);
  var hostOffset = getHostOffset(el);
  var left = hostOffset.left + (DomHandler_DomHandler.getOuterWidth(el) - DomHandler_DomHandler.getOuterWidth(tooltipElement)) / 2;
  var top = hostOffset.top - DomHandler_DomHandler.getOuterHeight(tooltipElement);
  tooltipElement.style.left = left + 'px';
  tooltipElement.style.top = top + 'px';
}
function alignBottom(el) {
  ...
  var hostOffset = getHostOffset(el);
  var left = hostOffset.left + (DomHandler_DomHandler.getOuterWidth(el) - DomHandler_DomHandler.getOuterWidth(tooltipElement)) / 2;
  var top = hostOffset.top + DomHandler_DomHandler.getOuterHeight(el);
  tooltipElement.style.left = left + 'px';
  tooltipElement.style.top = top + 'px';
}
...
function isOutOfBounds(el) {
  ...
  var width = DomHandler_DomHandler.getOuterWidth(tooltipElement);
  var height = DomHandler_DomHandler.getOuterHeight(tooltipElement);
...
/* harmony default export */ var entry_lib = __webpack_exports__["default"] = (tooltip_Tooltip);
