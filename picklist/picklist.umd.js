(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["picklist"] = factory();
	else
		root["picklist"] = factory();
...
/* harmony default export */ var PickListvue_type_script_lang_js_ = ({
  props: {
    value: {
      type: Array,
  ...
  methods: {
    ...
    isSelected: function isSelected(item, listIndex) {
      return ObjectUtils_ObjectUtils.findIndexInList(item, this.d_selection[listIndex]) != -1;
    },
    ...
    findNextItem: function findNextItem(item) {
      ...
      if (nextItem) return !DomHandler_DomHandler.hasClass(nextItem, 'p-picklist-item') ? this.findNextItem(nextItem) : nextItem;else return null;
    },
    findPrevItem: function findPrevItem(item) {
      var prevItem = item.previousElementSibling;
      if (prevItem) return !DomHandler_DomHandler.hasClass(prevItem, 'p-picklist-item') ? this.findPrevItem(prevItem) : prevItem;else return null;
    },
...
var PickList_component = normalizeComponent(
  picklist_PickListvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var PickList = (PickList_component.exports);
// CONCATENATED MODULE: ./node_modules/@vue/cli-service/lib/commands/build/entry-lib.js


/* harmony default export */ var entry_lib = __webpack_exports__["default"] = (PickList);
